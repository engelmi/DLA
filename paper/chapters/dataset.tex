...
\begin{enumerate}
	\item Training and Validation: This dataset contains $\text{TODO}$ entries and can be found in \mbox{\italic{stockprediction/datasets/myDataset}}.
	\item Test: This dataset is used only for testing and never during training. It is located at \mbox{\italic{stockprediction/datasets/testData}} and has $\text{TODO}$ entries which is about $\text{TODO}\%$ of the training and validation category.
\end{enumerate}
